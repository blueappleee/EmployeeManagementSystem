...
CREATE TABLE IF NOT EXISTS employee(employeeID CHAR(6) NOT NULL, empType CHAR(3) NOT NULL, teamID CHAR(4), managerID CHAR(6), fName VARCHAR(20) NOT NULL, lNAME VARCHAR(20) NOT NULL, salary INT NOT NULL, position VARCHAR(40) NOT NULL, startDate DATE NOT NULL, birthDate DATE, sickDaysYearly SMALLINT NOT NULL, sickDaysRemaining SMALLINT, vacationDaysYearly SMALLINT NOT NULL, vacationDaysRemaining SMALLINT, address VARCHAR(50), phoneNumber VARCHAR(10), workEmail VARCHAR(40) NOT NULL, personalEmail VARCHAR(40), directDepositNumber CHAR(15), ssn CHAR(9) NOT NULL, PRIMARY KEY(employeeID));

CREATE TABLE IF NOT EXISTS manager(employeeID CHAR(6) NOT NULL, empType CHAR(3) NOT NULL, teamID CHAR(4), teamManagedID CHAR(4), managerID CHAR(6), fName VARCHAR(20) NOT NULL, lNAME VARCHAR(20) NOT NULL, salary INT NOT NULL, position VARCHAR(40) NOT NULL, startDate DATE NOT NULL, birthDate DATE, sickDaysYearly SMALLINT NOT NULL, sickDaysRemaining SMALLINT, vacationDaysYearly SMALLINT NOT NULL, vacationDaysRemaining SMALLINT, address VARCHAR(50), phoneNumber VARCHAR(10), workEmail VARCHAR(40) NOT NULL, personalEmail VARCHAR(40), directDepositNumber CHAR(15), ssn CHAR(9) NOT NULL, PRIMARY KEY(employeeID));
